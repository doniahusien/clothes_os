...
class _GlassesState extends State<Glasses> with TickerProviderStateMixin {
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "The Way we See the World is Different.",
          ...
          child: Consumer<TopDealer>(
            builder: (context, value, child) {
              return GridView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: value.maleGlass.length,
          ...
          child: Consumer<TopDealer>(
            builder: (context, value, child) {
              return GridView.builder(
                  physics: const ScrollPhysics(parent: ScrollPhysics()),
                  shrinkWrap: true,
                  itemCount: value.femaleGlass.length,
                  gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 2,
                    childAspectRatio: (0.72),
                  ),
