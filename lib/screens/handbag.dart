...
class _HandBagState extends State<HandBag> with TickerProviderStateMixin {
          ...
          child: Consumer<TopDealer>(
            builder: (context, value, child) {
              return GridView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: value.handBag.length,
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image:
                                            AssetImage(value.handBag[index][1]),
                                        fit: BoxFit.contain,
